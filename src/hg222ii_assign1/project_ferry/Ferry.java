...
//public class ferry {
	public interface Ferry  {
		   ...
		   int moneyCost();                  // Earned money
		   Iterator<Vehicle> iterator();      // Vehicle iterator   
		   void embark(Vehicle v) throws VehiclePlaceExceededException;            // Embark vehicle, warning if not enough space
		   void embark(Passenger p) throws PassengerPlaceExceededException;          // Embark passenger, warning if not enough room
